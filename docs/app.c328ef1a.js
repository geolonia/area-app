...
var clickFeature = function clickFeature(event) {
  ...
  var asDome = (area / areaDome).toFixed(1);
...
map.on('load', function () {
  ...
  map.setPaintProperty("building", 'fill-color', ["case", ["boolean", ["feature-state", "hover"], false], "#ff0000", "#dedede"]);
  map.setPaintProperty("building", 'fill-opacity', ["case", ["boolean", ["feature-state", "hover"], false], 0.2, 1]);
});
