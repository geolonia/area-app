...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"../node_modules/@turf/helpers/index.js":[function(require,module,exports) {
"use strict";
...
},{"@turf/meta":"../node_modules/@turf/meta/index.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var areaDome = 46755;
var map = new tilecloud.Map(document.querySelector('#map'));

var clickFeature = function clickFeature(event) {
  map.queryRenderedFeatures({
    layters: map.getStyle().layers
  ...
  for (var i = 0; i < features.length; i++) {
    ...
    if ('fill' === feature.layer.type) {
      ...
      var area = (0, _area.default)(feature.geometry).toFixed(1);
      var asDome = (area / areaDome).toFixed(4);
      console.log(feature);
      new mapboxgl.Popup().setLngLat(event.lngLat).setHTML("\u3053\u306E\u5EFA\u7269\u306E\u9762\u7A4D\u306F ".concat(area, "\u33A1 \u3067\u3001\u6771\u4EAC\u30C9\u30FC\u30E0 ").concat(asDome, " \u500B\u5206\u306E\u9762\u7A4D\u3067\u3059\u3002")).addTo(map);
      break;
    }
  }
};
...
map.on('load', function () {
  map.getStyle().layers.forEach(function (item) {
    ...
    if ('fill' === item.type) {
      var color = map.getPaintProperty(item.id, 'fill-color');
      var opacity = map.getPaintProperty(item.id, 'fill-opacity');
      ...
      if (color) {
        map.setPaintProperty(item.id, 'fill-color', ["case", ["boolean", ["feature-state", "hover"], false], "#ff0000", color]);
      }

      if (opacity) {
        map.setPaintProperty(item.id, 'fill-opacity', ["case", ["boolean", ["feature-state", "hover"], false], 0.2, parseFloat(opacity)]);
      }
    }
  });
});
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","@turf/area":"../node_modules/@turf/area/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
